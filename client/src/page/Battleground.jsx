...
const Battleground = () => {
  const { setBattleGround, Battleground, setShowAlert, showAlert } = useGlobalContext();
  ...
  return (
    <div className={`${styles.flexCenter} ${styles.battlegroundContainer}`}>
       {showAlert?.status && <Alert type={showAlert.type} message={showAlert.message} />}
        ...
        <h1 className={`${styles.headText} text-center`}>Choose your <span className='text-siteViolet'>Battle</span> Ground
        </h1>
