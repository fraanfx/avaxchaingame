...
const AddNewEvent = (eventFilter, provider, cbFunc) =>  {
    provider.removeListener(eventFilter); //prevent not have multiple listeners at the same event
    ...
    AddNewEvent(NewGameTokenEventFilter, provider, ({ args }) => {
        ...
        if( walletAddress.toLowerCase() === args.owner.toLowerCase()){
            setShowAlert({
                status: true,
                type: 'success',
                message: 'Player game token has been succesfully generated',
            });
